...
/***/ 201:
/*!************************************************************************!*\
  !*** D:/0000乐木同行/lmtx-applet/main.js?{"page":"pages%2Flogin%2Flogin"} ***!
  \************************************************************************/
...
/***/ 202:
/*!*****************************************************!*\
  !*** D:/0000乐木同行/lmtx-applet/pages/login/login.vue ***!
  \*****************************************************/
/*! no static exports found */
...
/* harmony import */ var _login_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login.vue?vue&type=style&index=0&lang=scss& */ 207);
...
/***/ 203:
/*!************************************************************************************!*\
  !*** D:/0000乐木同行/lmtx-applet/pages/login/login.vue?vue&type=template&id=b237504c& ***!
  \************************************************************************************/
...
/***/ 204:
/*!************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--17-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/0000乐木同行/lmtx-applet/pages/login/login.vue?vue&type=template&id=b237504c& ***!
  \************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 205:
/*!******************************************************************************!*\
  !*** D:/0000乐木同行/lmtx-applet/pages/login/login.vue?vue&type=script&lang=js& ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 206:
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/0000乐木同行/lmtx-applet/pages/login/login.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _default = {
  ...
  methods: {
    ...
    getUser: function getUser() {
      ...
      uni.getUserProfile({
        ...
        success: function success(res) {
          console.log('授权', res);
          _this.userTemp = res.userInfo; //用户信息放到usertemp里
          uni.login({
            provider: 'weixin',
            success: function success(loginRes) {
              console.log('微信授权1', loginRes);
              _this.loginData = loginRes;
              // this.lock = false;
              // this.loginProcess = 2;
              _this.wxLogin();
            },
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                return wx.login();
              case 7:
                _this2.loginData = _context.sent;
                console.log('微信的wx.login', _this2.loginData);
                if (!_this2.lock) {
                  _context.next = 11;
                  break;
                }
              ...
              case 11:
                _this2.lock = true;
                params = {
                  code: _this2.loginData.code,
                  encrypted: e.detail.encryptedData,
                  iv: e.detail.iv
                };
                _context.next = 15;
                return _this2.$request('/applet/index/login/getPhone', params);
              case 15:
                res = _context.sent;
                if (!res.success) {
                  _context.next = 21;
              ...
              case 21:
                ...
                return _context.abrupt("return");
              case 23:
                _this2.lock = false; //获取完微信信息就false
                _this2.loginProcess = 3; //登录
                // 自动登录
                _this2.wxLogin();
              case 26:
              case "end":
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 7:
                ...
                return wx.login();
              case 9:
                _this3.loginData = _context2.sent;
                params = {
                  code: _this3.loginData.code,
                  nickname: _this3.userTemp.nickName,
                  sex: _this3.userTemp.gender,
                  photo: _this3.userTemp.avatarUrl,
                  ext1: _this3.phone
                };
                _context2.next = 13;
                return _this3.$request('/applet/index/login/login', params);
              case 13:
                res = _context2.sent;
                if (res.success) {
                  if (res.data.status === 1) {
                    uni.setStorageSync('userinfo', res.data);
                    _this3.$toast('登录成功!').then(function () {
                      uni.reLaunch({
                        url: '/pages/index/index' //登录成功来到首页
                      });
                    });
                  } else {
                    _this3.$toast('您的账号已被封禁!');
                  }
                } else {
                  his.$toast(res.msg);
                }
        ...
        return _regenerator.default.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                if (!_this4.$check.checkPhoneNumber(_this4.phone, '手机号', true)) {
                  _context3.next = 4;
                  break;
                }
                return _context3.abrupt("return");
              case 4:
                ...
                _context3.next = 7;
                return _this4.$request('/applet/index/login/getCode', params);
              case 7:
                res = _context3.sent;
                if (res.success) {
                  _this4.$toast('短信发送成功!');
    ...
    //倒计时
    gocountdown: function gocountdown() {
      var _this5 = this;
        ...
        return _regenerator.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 3:
                if (!_this6.$check.checkPhoneNumber(_this6.phone, '手机号', true)) {
                  _context4.next = 5;
                  break;
                }
                return _context4.abrupt("return");
              case 5:
                if (!_this6.$check.checkNull(_this6.code, '验证码', true)) {
                  _context4.next = 7;
                  break;
                }
                return _context4.abrupt("return");
              case 7:
                ...
                _context4.next = 10;
                return _this6.$request('/applet/index/login/codeLogin', params);
              case 10:
                res = _context4.sent;
                if (res.success) {
                  ...
                  if (res.data.status === 1) {
                    uni.setStorageSync('userinfo', res.data);
                    _this6.$toast('登录成功!').then(function () {
                      uni.reLaunch({
                        url: '/pages/index/index'
                      });
                    });
                  } else {
                    _this6.$toast('您的账号已被封禁!');
                  }
...
/***/ 207:
/*!***************************************************************************************!*\
  !*** D:/0000乐木同行/lmtx-applet/pages/login/login.vue?vue&type=style&index=0&lang=scss& ***!
  \***************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 208:
/*!*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/0000乐木同行/lmtx-applet/pages/login/login.vue?vue&type=style&index=0&lang=scss& ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
